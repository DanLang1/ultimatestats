...
export default function TutorialIntroRoute() {
      ...
      <View style={styles.content}>
        <View style={styles.leftColumn}>
          <Animated.View entering={FadeInDown.delay(200).springify()} style={styles.heroSection}>
            <ThemedText style={[styles.appName, { color: palette.textInverse }]}>U-Stat</ThemedText>
            <ThemedText style={[styles.tagline, { color: palette.textMuted }]}>
              Ultimate Frisbee Scoreboard / Stat Tracker
            </ThemedText>
          </Animated.View>
...
function createStyles(sizeClass: 'small' | 'medium' | 'large', useRowLayout: boolean) {
  ...
  return StyleSheet.create({
    ...
    appName: {
      fontSize: getSizeClassValue({ small: 56, medium: 64, large: 72 }, sizeClass),
      fontFamily: Fonts.black,
      letterSpacing: -1,
    },
    tagline: {
      fontSize: getSizeClassValue({ small: 18, medium: 21, large: 24 }, sizeClass),
    ...
    footer: {
      ...
      paddingHorizontal: useRowLayout ? scaleBySizeClass(0, sizeClass) : 0,
    },
    ctaButton: {
      width: '100%',
      maxWidth: useRowLayout
