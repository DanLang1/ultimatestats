...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      'IOS Release',
      'Updated tutorials',
      'Added showcase page (still in beta). Will act as library of stats for popular games.',
      'Misc bug fixes and UI updates',
    ],
  },
  {
    version: '1.8.0',
  ...
  },
  {
    ...
    date: 'March 1, 2026',
    changes: [
      'Tablet support for entire app',
      'Added screen orientation lock setting',
      'Added relative player stats / averages to player stats page',
      'Added time of possession to stats page if point timing is enabled',
      'Fixed few visual bugs on player stats page, revamped playing time section',
      'Game timeline now shows splits if point timing is enabled',
      'Game begin page now allows editing game settings directly',
      'Added team button on scoreboard to quickly make subs, check or edit lines',
      'Game to is now editable in the first half of a game',
    ],
  },
  {
    version: '1.6.0',
