...
| Modal routes       | `AdvancedGameSelectorModal`, `EditDurationModal`, `EditEventModal`, `EditPlayerModal`, `EditPointLineModal`, `GameSelectorModal`, `HalftimeModal`, `NumberPickerModal`, `PointSummaryModal`, `TeamManagementModal`, `TimeoutModal` | `test/routes/ModalRoutes.test.tsx`                                                                               |
